#Flask is used for creating web application
...
@app.route('/')
# In Flask, @app.route() is a decorator used to define the URL route for different views in your web application.
# @app.route('/') is a decorator that specifies that the home() function will be executed when the root URL ('/') of your web application is accessed.
def home():
    print("test1")
